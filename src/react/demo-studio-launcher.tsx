...
export interface DemoStudioLauncherProps {
...
export function DemoStudioLauncher({ controller }: DemoStudioLauncherProps) {
  ...
  return (
    ...
    >
      {mode === "demo" && (
        <>
          <span className="demo-studio-launcher-ring demo-studio-launcher-ring--demo" aria-hidden />
          <span className="demo-studio-launcher-ring demo-studio-launcher-ring--demo demo-studio-launcher-ring--offset" aria-hidden />
        </>
      )}
      {isScreencast && (
        <>
          <span className="demo-studio-launcher-ring demo-studio-launcher-ring--screencast" aria-hidden />
          <span className="demo-studio-launcher-ring demo-studio-launcher-ring--screencast demo-studio-launcher-ring--offset" aria-hidden />
          <span className="demo-studio-record-beacon" aria-hidden />
        </>
      )}
