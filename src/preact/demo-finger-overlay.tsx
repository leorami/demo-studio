...
export interface DemoFingerOverlayProps { controller: DemoStudioController; }
  ...
  return (
    <>
      {captionsEnabled && caption && (
        <div class="demo-studio-caption-container">
          <div role="status" aria-live="polite" data-testid="kyzmet-demo-caption" class="demo-studio-caption">
            {caption}
          </div>
        </div>
      )}
      <div data-testid="kyzmet-demo-finger-overlay" class="demo-studio-finger-overlay">
        <div data-testid="kyzmet-demo-finger-dot" class="demo-studio-finger-dot" style={{ transform: `translate(${pos.x - 14}px, ${pos.y - 14}px)` }} />
        {ripples.map((r) => <div key={r.id} class="demo-studio-ripple" style={{ left: r.x - 24, top: r.y - 24 }} />)}
      </div>
    </>
  );
}
