...
// src/react/demo-studio.tsx
import { useEffect as useEffect3, useRef as useRef3, useSyncExternalStore as useSyncExternalStore2 } from "react";

// src/react/demo-finger-overlay.tsx
...
function DemoFingerOverlay({ controller }) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    captionsEnabled && caption && /* @__PURE__ */ jsx("div", { className: "demo-studio-caption-container", children: /* @__PURE__ */ jsx("div", { role: "status", "aria-live": "polite", "data-testid": "kyzmet-demo-caption", className: "demo-studio-caption", children: caption }) }),
    /* @__PURE__ */ jsxs("div", { "data-testid": "kyzmet-demo-finger-overlay", className: "demo-studio-finger-overlay", children: [
      /* @__PURE__ */ jsx(
        "div",
        {
      ...
      ripples.map((r) => /* @__PURE__ */ jsx("div", { className: "demo-studio-ripple", style: { left: r.x - 24, top: r.y - 24 } }, r.id))
    ] })
  ] });
}
...
function ClapperboardIcon({ className, style, ...rest }) {
  return /* @__PURE__ */ jsxs2("svg", { viewBox: "0 0 24 24", fill: "none", className, style, ...rest, children: [
    ...
    /* @__PURE__ */ jsx2("line", { x1: "7", y1: "5", x2: "5", y2: "3", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round" }),
    /* @__PURE__ */ jsx2("line", { x1: "12", y1: "5", x2: "10", y2: "3", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round" }),
    /* @__PURE__ */ jsx2("line", { x1: "17", y1: "5", x2: "15", y2: "3", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round" }),
    /* @__PURE__ */ jsx2("line", { x1: "22", y1: "5", x2: "20", y2: "3", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round" })
  ] });
}
function ClapperboardOpenIcon({ className, style, ...rest }) {
  return /* @__PURE__ */ jsxs2("svg", { viewBox: "0 0 24 24", fill: "none", className, style, ...rest, children: [
    ...
    /* @__PURE__ */ jsx2("line", { x1: "6.5", y1: "4.5", x2: "5.5", y2: "2.5", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round" }),
    /* @__PURE__ */ jsx2("line", { x1: "11.5", y1: "5.5", x2: "10.5", y2: "3.5", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round" }),
    /* @__PURE__ */ jsx2("line", { x1: "16.5", y1: "6.5", x2: "15.5", y2: "4.5", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round" })
  ] });
}
...
function CloseIcon({ className, style, ...rest }) {
  return /* @__PURE__ */ jsx2("svg", { viewBox: "0 0 24 24", fill: "none", className, style, ...rest, children: /* @__PURE__ */ jsx2("path", { d: "M18 6L6 18M6 6l12 12", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }) });
}

// src/react/demo-studio-launcher.tsx
    ...
    "button",
    {
      ...
      children: [
        mode === "demo" && /* @__PURE__ */ jsxs3(Fragment2, { children: [
          /* @__PURE__ */ jsx3("span", { className: "demo-studio-launcher-ring demo-studio-launcher-ring--demo", "aria-hidden": true }),
          /* @__PURE__ */ jsx3("span", { className: "demo-studio-launcher-ring demo-studio-launcher-ring--demo demo-studio-launcher-ring--offset", "aria-hidden": true })
        ] }),
        isScreencast && /* @__PURE__ */ jsxs3(Fragment2, { children: [
          /* @__PURE__ */ jsx3("span", { className: "demo-studio-launcher-ring demo-studio-launcher-ring--screencast", "aria-hidden": true }),
          /* @__PURE__ */ jsx3("span", { className: "demo-studio-launcher-ring demo-studio-launcher-ring--screencast demo-studio-launcher-ring--offset", "aria-hidden": true }),
          /* @__PURE__ */ jsx3("span", { className: "demo-studio-record-beacon", "aria-hidden": true })
        ] }),
...
// src/react/demo-studio-panel.tsx
  ...
  return /* @__PURE__ */ jsxs4(Fragment3, { children: [
    open && !running && /* @__PURE__ */ jsxs4(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs4("div", { className: "demo-studio-panel-header", children: [
            /* @__PURE__ */ jsx4("div", { className: "demo-studio-panel-header-icon-badge", "aria-hidden": true, children: /* @__PURE__ */ jsx4(ClapperboardIcon, {}) }),
            /* @__PURE__ */ jsxs4("div", { style: { flex: 1, minWidth: 0 }, children: [
              /* @__PURE__ */ jsx4("p", { className: "demo-studio-panel-header-title", children: "Demo Studio" }),
              /* @__PURE__ */ jsx4("p", { className: "demo-studio-panel-header-subtitle", children: "Create screencasts" })
            ] }),
            /* @__PURE__ */ jsx4("div", { className: "demo-studio-panel-header-actions", children: /* @__PURE__ */ jsx4("button", { type: "button", className: "demo-studio-panel-header-close", "aria-label": "Close Demo Studio", onClick: () => actions.setOpen(false), children: /* @__PURE__ */ jsx4(CloseIcon, {}) }) })
          ] }),
          /* @__PURE__ */ jsxs4("div", { className: "demo-studio-panel-body", children: [
            /* @__PURE__ */ jsxs4("div", { className: "demo-studio-field-group", children: [
              /* @__PURE__ */ jsx4("label", { htmlFor: "demo-studio-journey", className: "demo-studio-field-label", children: "Journey" }),
              /* @__PURE__ */ jsx4(
                "select",
                {
            ...
            /* @__PURE__ */ jsxs4("div", { className: "demo-studio-field-group", children: [
              /* @__PURE__ */ jsxs4("label", { htmlFor: "demo-studio-speed", className: "demo-studio-field-label", children: [
                "Speed ",
            ...
            /* @__PURE__ */ jsxs4("div", { className: "demo-studio-field-group", children: [
              /* @__PURE__ */ jsx4("label", { htmlFor: "demo-studio-refine", className: "demo-studio-field-label", children: "Refine (optional)" }),
              /* @__PURE__ */ jsx4(
                "textarea",
                {
                  id: "demo-studio-refine",
                  className: "demo-studio-textarea",
            ...
            errorMsg && /* @__PURE__ */ jsx4("p", { className: "demo-studio-status demo-studio-status--error", children: errorMsg }),
            runStatus === "done" && /* @__PURE__ */ jsx4("p", { className: "demo-studio-status demo-studio-status--success", children: "\u2713 Demo complete" }),
            recorderState === "done" && runStatus === "done" && /* @__PURE__ */ jsx4("p", { className: "demo-studio-status demo-studio-status--success", children: "\u2713 Screencast downloaded" }),
            /* @__PURE__ */ jsxs4("div", { className: "demo-studio-actions", children: [
              /* @__PURE__ */ jsx4("button", { type: "button", className: "demo-studio-btn demo-studio-btn--primary", onClick: () => void actions.startRun(), disabled: !resolvedJourney, "data-testid": "kyzmet-demo-studio-run", children: "Run demo" }),
              /* @__PURE__ */ jsx4("button", { type: "button", className: "demo-studio-btn demo-studio-btn--secondary", onClick: () => void actions.startScreencast(), disabled: !resolvedJourney || !isScreencastSupported(), title: !isScreencastSupported() ? "Screen recording not supported \u2014 use Chrome" : "Capture the screen while the demo runs", "data-testid": "kyzmet-demo-studio-screencast", children: "Screencast" })
            ] })
          ] })
        ]
      }
...
function ToggleRow({ id, label, description, checked, onChange, testId }) {
  return /* @__PURE__ */ jsxs4("div", { className: "demo-studio-toggle-row", children: [
    /* @__PURE__ */ jsxs4("div", { className: "demo-studio-toggle-text", children: [
      /* @__PURE__ */ jsx4("label", { htmlFor: id, className: "demo-studio-toggle-label", children: label }),
      /* @__PURE__ */ jsx4("p", { className: "demo-studio-toggle-description", children: description })
    ] }),
    /* @__PURE__ */ jsx4(
      "button",
      {
        ...
        role: "switch",
        id,
        className: "demo-studio-toggle",
        "aria-checked": checked ? "true" : "false",
        onClick: () => onChange(!checked),
        "data-testid": testId,
        children: /* @__PURE__ */ jsx4("span", { className: "demo-studio-toggle-knob" })
      }
    )
  ] });
}
...
function DemoStudio({ className, style, ...opts }) {
  ...
  useSyncExternalStore2(controller.subscribe, controller.getState, controller.getState);
