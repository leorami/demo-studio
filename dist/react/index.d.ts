...
declare function DemoStudio({ className, style, ...opts }: DemoStudioProps): react.JSX.Element;

interface DemoStudioPanelProps {
    controller: DemoStudioController;
}
declare function DemoStudioPanel({ controller }: DemoStudioPanelProps): react.JSX.Element;

interface DemoStudioLauncherProps {
    controller: DemoStudioController;
}
declare function DemoStudioLauncher({ controller }: DemoStudioLauncherProps): react.JSX.Element;

interface DemoFingerOverlayProps {
    controller: DemoStudioController;
}
declare function DemoFingerOverlay({ controller }: DemoFingerOverlayProps): react.JSX.Element | null;
